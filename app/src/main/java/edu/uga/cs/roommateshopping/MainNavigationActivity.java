...
/**
 * This MainNavigationActivity displays the screen that users will see when they either
 * successfully register or log in. This just sets all the buttons on this page
 * and makes their listeners.
 */
